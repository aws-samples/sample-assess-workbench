...
const TOKEN_KEYS = {
  idToken: 'risk_assessor_id_token',
  accessToken: 'risk_assessor_access_token',
  refreshToken: 'risk_assessor_refresh_token',
  expiresAt: 'risk_assessor_expires_at',
};
...
const SIGNED_OUT_KEY = 'risk_assessor_signed_out';
...
export function AuthProvider({ children }) {
  const [user, setUser] = useState(() => {
    ...
    return {
      ...
      // federated-derived. cfg/federated retained for diagnostics only.
