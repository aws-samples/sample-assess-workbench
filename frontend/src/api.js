...
export function listModels() {
  return api('/models', {}, 'Failed to list models');
}
...
export function listBenchmarks() {
  return api('/benchmarks', {}, 'Failed to list benchmarks');
}

export function createBenchmark(name, documentProjectId, agentType, configurations) {
  return api(
    '/benchmarks',
    { method: 'POST', body: JSON.stringify({ name, document_project_id: documentProjectId, agent_type: agentType, configurations }) },
    'Failed to create benchmark',
  );
}

export function getBenchmark(benchmarkId) {
  return api(`/benchmarks/${benchmarkId}`, {}, 'Failed to get benchmark');
}

export function runBenchmark(benchmarkId) {
  return api(`/benchmarks/${benchmarkId}/run`, { method: 'POST' }, 'Failed to run benchmark');
}

export function deleteBenchmark(benchmarkId) {
  return api(`/benchmarks/${benchmarkId}`, { method: 'DELETE' }, 'Failed to delete benchmark');
}
