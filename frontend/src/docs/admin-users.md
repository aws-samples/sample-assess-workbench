...
|-------|------|--------------|
| `admins` | Admin | Full write, plus agent registry, benchmarks, standards, and guardrail-event management |
...
2. Select the `risk-assessor-users-dev` pool (or your environment's pool)
