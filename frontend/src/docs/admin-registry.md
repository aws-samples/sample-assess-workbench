...
- **Model selection** — the review model is set at deploy time
...
|----------|-------------|---------|
| `severity_badge` | Standard severity badge | Default (fallback) |
| `severity_badge_with_tags` | Severity + reference/compliance tags | Security, AU FSI Compliance |
