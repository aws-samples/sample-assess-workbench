...
const MODEL_INFO = {
  'us.anthropic.claude-sonnet-4-6': { name: 'Claude Sonnet 4', contextWindow: 200_000 },
  'us.anthropic.claude-haiku-4-5-20251001-v1:0': { name: 'Claude Haiku 4.5', contextWindow: 200_000 },
  'us.anthropic.claude-sonnet-4-20250514-v1:0': { name: 'Claude Sonnet 4', contextWindow: 200_000 },
};
