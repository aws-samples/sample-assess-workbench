...
class ReviewHandlers:
    ...
    def trigger_review(self, project_id: str, event: Dict[str, Any],
    ...
    def get_review_plan(self, project_id: str, review_id: str,
    ...
    def reject_review_plan(self, project_id: str, review_id: str,
        ...
        try:
            ...
            result = self.review_service.reject_review_plan(
                project_id, review_id, reason=reason
            )
            return success_response(result)
    ...
    def abort_review(self, project_id: str, review_id: str,
        ...
        try:
            ...
            result = self.review_service.abort_review(
                project_id, review_id, reason=reason
            )
            return success_response(result)
    ...
    def get_review_events(self, project_id: str, review_id: str,
        ...
        try:
            ...
            result = self.review_service.get_review_events(
                project_id, review_id, after=after,
            )
            return success_response(result)
    ...
    def get_report(self, project_id: str, event: Dict[str, Any],
                   context: Any) -> Dict[str, Any]:
