...
class ContextHandlers:
    ...
    def get_context(self, context_id: str, event: Dict[str, Any],
    ...
    def delete_context(self, context_id: str, event: Dict[str, Any],
                       context: Any) -> Dict[str, Any]:
    ...
    def get_context_content(self, context_id: str, event: Dict[str, Any],
                            context: Any) -> Dict[str, Any]:
    ...
    def update_context_content(self, context_id: str, event: Dict[str, Any],
                               context: Any) -> Dict[str, Any]:
