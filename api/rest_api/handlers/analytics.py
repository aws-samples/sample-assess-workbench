...
class AnalyticsHandlers:
    ...
    def get_summary(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
        ...
        Admins receive aggregate analytics across all projects. Users and
        viewers receive analytics scoped to their own projects.
        ...
        try:
            scoped_sub = '' if role == UserRole.ADMIN else user_sub
    ...
    def get_trends(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
        ...
        Admins receive aggregate trends across all projects. Users and
        viewers receive trends scoped to their own projects.
        ...
        try:
            ...
            result = self.analytics_service.get_trends(
                agent_type=agent_type, limit=limit, user_sub=scoped_sub,
            )
            return success_response(result)
        except Exception as e:
    ...
    def get_coverage(self, project_id: str, event: Dict[str, Any],
