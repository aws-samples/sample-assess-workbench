...
class StandardsHandlers:
    ...
    def delete_standard(self, standard_id: str, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    def update_metadata(self, standard_id: str, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
