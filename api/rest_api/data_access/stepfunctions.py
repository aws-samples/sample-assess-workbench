...
class StepFunctionsDataAccess:
    ...
    def start_review_execution(self, project_id: str, review_id: str,
                              s3_bucket: str, s3_key: str,
                              connection_id: str = '', websocket_endpoint: str = '',
                              user_sub: str = '', files: list = None) -> Dict[str, Any]:
    ...
    def send_task_failure(self, task_token: str, error: str = 'UserRejected',
                          cause: str = '') -> None:
