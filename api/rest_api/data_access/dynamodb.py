...
class DynamoDBDataAccess:
    ...
    def create_project(self, project_id: str, name: str, description: str,
                      s3_bucket: str, s3_key: str, created_by: str = '',
    ...
    def set_project_in_progress(self, project_id: str,
    ...
    def create_review(self, project_id: str, review_id: str,
                     findings_s3_bucket: str, findings_s3_key: str,
    ...
    def create_context(self, context_id: str, name: str, description: str,
                       s3_bucket: str, s3_key: str, created_by: str = '') -> Dict[str, Any]:
    ...
    def update_plan_status(self, project_id: str, review_id: str, status: str,
                           approved_plan: Dict = None, modified: bool = False) -> None:
    ...
    def persist_event(self, project_id: str, review_id: str,
    ...
    def put_feedback(self, project_id: str, agent_type: str, finding_id: str,
                     value: str, user: str) -> Dict[str, Any]:
    ...
    def create_agent_registry_entry(self, agent_type: str, fields: Dict[str, Any]) -> Dict[str, Any]:
