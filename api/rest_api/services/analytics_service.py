...
class AnalyticsService:
    """Aggregates data from reviews and feedback for the dashboard."""
    ...
    def get_summary(self, user_sub: str = "") -> Dict[str, Any]:
        ...
        for project in completed[:50]:  # Cap to avoid timeout
            ...
            for agent_type, agent_data in reviews_data.items():
                ...
                agent_finding_counts[agent_type] = (
                    agent_finding_counts.get(agent_type, 0) + finding_count
                )
    ...
    def get_trends(
        self, agent_type: Optional[str] = None, limit: int = 30, user_sub: str = ""
    ) -> Dict[str, Any]:
