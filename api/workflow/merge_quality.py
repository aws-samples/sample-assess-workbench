...
EXPECTED_EVENT = {
    ...
    'optional': ['quality_results', 'quality_error',
...
def lambda_handler(event: dict, context) -> dict:
    ...
    if quality_error or not quality_results:
        ...
        send_progress(connection_id, websocket_endpoint, 'quality_evaluation_failed', {
            'error': error_msg[:200],
        })
    ...
    send_progress(connection_id, websocket_endpoint, 'quality_evaluation_complete', {
...
def _emit_review_complete(findings: dict, connection_id: str, websocket_endpoint: str) -> None:
    ...
    send_progress(connection_id, websocket_endpoint, 'review_complete', {
