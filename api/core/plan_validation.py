            ...
            validated_groups.append(
                {
                    ...
                    if group.get("execution") in ("parallel", "sequential")
                    else "parallel",
                                    ...
                                    "agents": {
                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                ...
                                                "prompt_addendum": {
                                                    "type": "string",
                                                    "description": "Document-specific guidance for this agent",
                                                },
                                                "judge": {
                                                    "type": "object",
                                                    ...
                                                    "properties": {
                                                        "enabled": {
                                                            "type": "boolean",
                                                            "description": "Whether to enable coach loop for this agent",
                                                        },
                                                        "max_iterations": {
                                                            "type": "integer",
                                                            "minimum": 1,
                                                            "maximum": 5,
                                                            "description": "Max coaching iterations (1-5)",
                                                        },
                                                        "quality_threshold": {
                                                            "type": "number",
                                                            "minimum": 0.5,
                                                            "maximum": 1.0,
                                                            "description": "Score threshold to pass (0.5-1.0)",
                                                        },
                                                    },
                                                },
                                            },
