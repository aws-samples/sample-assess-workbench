...
- Do recommendations stay within scope — controls and safeguards within the org's chosen platforms and vendors, rather than wholesale replacement of the cloud provider, vendor, or platform? A recommendation to migrate clouds or replatform is out of scope for this agent and should be flagged as a rubric miss.
