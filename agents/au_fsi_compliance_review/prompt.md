...
1. CPS 230 — OPERATIONAL RISK MANAGEMENT (effective 1 July 2025)
...
2. CPS 234 — INFORMATION SECURITY (effective since 1 July 2019)
   ...
   - Incident management — detection, response, and notification to APRA within 72 hours for material incidents
...
7. APRA SUPERVISORY COMMENTARY — CURRENT ENFORCEMENT FOCUS
   - 2025 tripartite assessment findings: incomplete asset classification, inadequate authentication controls, sporadic third-party assurance, irregular testing programs
...
- Connect findings to business consequences where possible (e.g., "failure to notify APRA of a material information security incident within 72 hours may result in supervisory action" rather than purely regulatory descriptions)
