...
class TestBasicStructure:
    ...
    def test_title_and_timestamp(self):
        md = render_markdown_report(
            reviews={}, summary=_make_summary(),
            project_name='My Project', created_at='2025-01-15T10:00:00Z',
        )
    ...
    def test_executive_summary_table(self):
        md = render_markdown_report(
            reviews={}, summary=_make_summary(critical=1, high=2, medium=3, low=4),
            project_name='Test', created_at='2025-01-01',
        )
    ...
    def test_empty_reviews_produces_valid_markdown(self):
        md = render_markdown_report(
            reviews={}, summary=_make_summary(),
            project_name='Empty', created_at='2025-01-01',
        )
...
class TestAgentOrdering:
    ...
    def test_alphabetical_without_plan(self):
        ...
        md = render_markdown_report(
            reviews=reviews, summary=_make_summary(),
            project_name='Test', created_at='2025-01-01',
        )
    ...
    def test_plan_group_order_with_alpha_within_group(self):
        ...
        md = render_markdown_report(
            reviews=reviews, summary=_make_summary(),
            project_name='Test', created_at='2025-01-01', plan=plan,
        )
...
class TestSeveritySorting:
    ...
    def test_findings_sorted_by_severity(self):
        ...
        md = render_markdown_report(
            reviews=reviews, summary=_make_summary(critical=1, high=1, low=1),
            project_name='Test', created_at='2025-01-01',
        )
...
class TestSecurityEnrichment:
    ...
    def test_owasp_and_cwe_rendered(self):
        ...
        md = render_markdown_report(
            reviews=reviews, summary=_make_summary(high=1),
            project_name='Test', created_at='2025-01-01',
        )
...
class TestRiskEnrichment:
    ...
    def test_likelihood_consequence_treatment(self):
        finding = _make_finding(
            likelihood='likely', consequence='major', risk_treatment='mitigate',
        )
    ...
    def test_residual_risk_when_present(self):
        finding = _make_finding(
            ...
            risk_treatment='mitigate', residual_risk='low',
        )
        reviews = {'risk': {'findings': [finding], 'status': 'completed'}}
        md = render_markdown_report(
            reviews=reviews, summary=_make_summary(high=1),
    ...
    def test_residual_risk_omitted_when_empty(self):
        finding = _make_finding(
            likelihood='likely', consequence='major',
            risk_treatment='mitigate', residual_risk='',
        )
        reviews = {'risk': {'findings': [finding], 'status': 'completed'}}
        md = render_markdown_report(
            reviews=reviews, summary=_make_summary(high=1),
...
class TestEdgeCases:
    ...
    def test_finding_missing_optional_fields(self):
        ...
        finding = {'id': 'X1', 'severity': 'medium', 'title': 'Bare Finding',
                    'description': '', 'recommendation': ''}
        reviews = {'security': {'findings': [finding], 'status': 'completed'}}
        md = render_markdown_report(
            reviews=reviews, summary=_make_summary(medium=1),
            project_name='Test', created_at='2025-01-01',
        )
...
class TestConsolidatedActionItems:
    ...
    def test_action_items_sorted_by_severity(self):
        ...
        md = render_markdown_report(
            reviews=reviews, summary=_make_summary(critical=1, medium=1),
            project_name='Test', created_at='2025-01-01',
        )
    ...
    def test_sequential_ids(self):
        ...
        md = render_markdown_report(
            reviews=reviews, summary=_make_summary(high=3),
            project_name='Test', created_at='2025-01-01',
        )
        assert 'F-001' in md
        assert 'F-002' in md
