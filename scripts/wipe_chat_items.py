...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--region", default=None, help="AWS region (defaults to profile/env default)"
    )
...
def main() -> None:
    ...
    print(
        f"Mode:    {'DRY RUN (no writes)' if args.dry_run else 'LIVE (will delete from DynamoDB)'}"
    )
    print()
